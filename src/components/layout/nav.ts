...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/app/accounts/journals', label: 'Journal Entries', icon: BookOpen, short: 'Journals' },
      { to: '/app/accounts/ledger', label: 'General Ledger', icon: Scale, short: 'Ledger' },
      {
        to: '/app/accounts/bank-accounts',
        label: 'Bank Accounts',
        icon: Building2,
        short: 'Banks',
      },
      { to: '/app/accounts/bank-import', label: 'Bank Import', icon: Upload, short: 'Import' },
      {
      ...
      { to: '/app/accounts/gst', label: 'GST', icon: Percent, short: 'GST' },
      { to: '/app/accounts/gst-returns', label: 'GST Returns', icon: FileText, short: 'Returns' },
      { to: '/app/accounts/einvoice', label: 'E-Invoice', icon: FileText, short: 'IRN' },
      { to: '/app/accounts/eway', label: 'E-Way Bill', icon: Truck, short: 'EWB' },
      { to: '/app/accounts/tax-config', label: 'Tax Configuration', icon: Percent, short: 'Tax' },
      {
        to: '/app/accounts/financials',
        label: 'Financial Statements',
        icon: BarChart3,
        short: 'P&L/BS',
      },
      {
        to: '/app/accounts/periods',
